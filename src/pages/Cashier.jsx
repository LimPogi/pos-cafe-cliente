...
export default function Cashier() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f9f9f9' }}>
      ...
      {/* RIGHT: Cart Panel */}
      <div style={{ flex: 1, backgroundColor: '#fff', borderLeft: '2px solid #ddd', padding: '20px', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {cart.map(item => (
            <div key={item.id} style={cartItemStyle}>
              ...
              <button onClick={() => removeFromCart(item.id)} style={{ border: 'none', background: 'none', color: 'red', cursor: 'pointer' }}>
                <Trash2 size={18} />
              </button>
            </div>
          ))}
